...
__title__ = "make terminal block phoenix 3D models exported to STEP and VRML"
__author__ = "scripts: maurice, Frank, Shack and grob6000; models: see cq_model files; update: jmwright"
...
from .terminalblock_phoenix import make_part
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("TerminalBlock_Phoenix")
    ...
    for model in models:
        ...
        (body, pins) = make_part(all_params[model])
        ...
        file_name = model  # all_params[model]['model_name']
