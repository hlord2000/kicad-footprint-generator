...
__title__ = "make chip resistor array 3D models exported to STEP and VRML"
...
from .resistors_array_smd import make_chip
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("resistors_array_SMD")
    ...
    for model in models:
        ...
        (body, body_top, pins) = make_chip(all_params[model])
