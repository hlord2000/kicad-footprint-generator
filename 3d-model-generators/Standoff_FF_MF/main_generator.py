...
__title__ = "make standoff 3D models exported to STEP and VRML"
...
from .standoff_ff_mf import make_standoff
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("Standoff_FF_MF")
    ...
    for model in models:
        ...
        body = make_standoff(all_params[model])
