...
__author__ = (
    "scripts: maurice and poeschlr; models: see cq_model files; update: jmwright"
)
...
from .cq_models import conn_te_84952, conn_te_84953
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        latch_color = shaderColors.named_colors[
            all_params[model]["latch_color_key"]
        ].getDiffuseFloat()
        ...
        for num_pins in all_params[model]["pin_range"]:
            ...
            component.add(
                latch,
                color=cq_color_correct.Color(
                    latch_color[0], latch_color[1], latch_color[2]
                ),
            )
