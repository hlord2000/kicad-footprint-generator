...
__title__ = "make DC to DC converter 3D models exported to STEP and VRML"
...
from .varistor import make_varistor
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("Varistor")
    ...
    for model in models:
        ...
        (body, pins) = make_varistor(all_params[model])
