...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    for model in models:
        ...
        for part in all_params[model]["parts"]:
            ...
            # Make sure the number of pins is padded properly
            if all_params[model]["parts"][part]["pins"] < 10:
                pins_padded_str = "0" + str(all_params[model]["parts"][part]["pins"])
            else:
                pins_padded_str = str(all_params[model]["parts"][part]["pins"])
