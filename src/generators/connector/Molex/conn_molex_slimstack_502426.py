...
def generate_one_footprint(generator_name: str, global_config: GC.GlobalConfig, partnumber, configuration):
...
def generate_all(generator_name: str, global_config: GC.GlobalConfig, configuration: dict[str, Any]) -> int:
    ...
    for partnumber in valid_pns:
        generate_one_footprint(generator_name, global_config, partnumber, configuration)
        num_fps_generated += 1
