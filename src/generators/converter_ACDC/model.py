...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("Converter_ACDC")
    ...
    for model in models:
        ...
        case = make_case(all_params[model])
        case_top = make_case_top(all_params[model])

        if all_params[model]["pintype"] == CASE_THT_TYPE:
            pins = make_pins_tht(all_params[model])

        if all_params[model]["pintype"] == CASE_THT_N_TYPE:
