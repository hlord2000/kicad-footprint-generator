...
__title__ = "make RF antenna chip 3D models exported to STEP and VRML"
__author__ = (
    "scripts: maurice, Frank and Shack; models: see cq_model files; update: jmwright"
)
...
from .rf_antenna_chip_smd import make_chip
...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("RF_Antenna_Chip_SMD")
    ...
    for model in models:
        ...
        (body, pins, pinmark) = make_chip(all_params[model])
        ...
        parts: list[cq.Workplane] = [body, pins, pinmark]
