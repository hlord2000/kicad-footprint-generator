...
def make_models(model_to_build=None, output_dir_prefix=None, enable_vrml=True):
    ...
    all_params = parameters.load_parameters("Converter_DCDC")
    ...
    for model in models:
        ...
        translation = (
            ...
            if "translation" in all_params[model]
            else (0, 0, 0)
        )
        case = case.translate(translation).rotate(
            (0, 0, 0), (0, 0, 1), all_params[model]["rotation"]
        )
        case_top = case_top.translate(translation).rotate(
            (0, 0, 0), (0, 0, 1), all_params[model]["rotation"]
        )
        pins = pins.translate(translation).rotate(
            (0, 0, 0), (0, 0, 1), all_params[model]["rotation"]
        )
